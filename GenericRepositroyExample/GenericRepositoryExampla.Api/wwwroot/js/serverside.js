...
// Class definition
var ContentDatatablesServerSide = function () {
    // Shared variables
    var table;
    var dt;
    var filterPayment;
    ...
    var initDatatable = function () {
        dt = $("#contentDatatable").DataTable({
            ...
            ajax: {
                url: "https://localhost:44363/api/Content/GetAllContents",
                type: "POST"
    ...
    var initToggleToolbar = function () {
        ...
        const container = document.querySelector('#contentDatatable');
